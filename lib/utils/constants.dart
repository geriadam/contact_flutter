...
const String GOOGLE_PLACE_API_KEY = "AIzaSyBL8v_gUXfiY3bYLRbTVjz3dwZB-RamLhE";
...
class SnackBarText {
  static const String IMPLEMENT_SQLITE = "Contacts App Implemented Using SQLITE";
...
class Texts {
  ...
  static const YOU_HAVE_NOT_YET_PICKED_AN_IMAGE = "You have not yet picked an image.";
  static const String CONTACT_STORED_IN_DELETED_CONTACTS_TABLE = "Contact Stored in Deleted Contacts Table";
  static const String UNABLE_TO_STORE_CONTACT_IN_DELETED_CONTACT_TABLE = "Unable to Store  Contact in Deleted Contacts Table";
  static const String LOGS_STORED_IN_LOGS_TABLE = "Logs Stored in Logs Table";
  static const String UNABLE_TO_STORE_LOGS_IN_LOG_TABLE = "Unable to Store  Logs in Logs Table";
}
