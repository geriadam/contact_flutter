...
import 'package:contact_flutter/pages/google_place_search.dart';
...
class CreateContactPageState extends State<CreateContactPage> {
  ...
  ProgressDialog progressDialog = ProgressDialog.getProgressDialog(ProgressDialogTitles.CREATING_CONTACT, false);
  File _imageFile;
