...
import 'package:contact_flutter/pages/deleted_contact_details.dart';
    ...
    return new Flexible(
        child: new Container(
          child: new Column(
            ...
            children: <Widget>[
              textContainer(deletedContact.name, Colors.green[400]),
              textContainer(deletedContact.phone, Colors.green[400]),
