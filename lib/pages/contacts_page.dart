...
import 'package:contact_flutter/pages/contact_details.dart';
import 'package:contact_flutter/pages/edit_contact_page.dart';
    ...
    return new Flexible(
        child: new Container(
          child: new Column(
            ...
            children: <Widget>[
              textContainer(contact.name, Colors.green[400]),
              textContainer(contact.phone, Colors.green[400]),
